...
public class HelloSeleniumTest {
    ...
    public static void setup() {
        // Setting up property manually. A true pain in the you know what. An absolute path too at that
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\ernest.nguyen\\drivers\\chrome\\98\\chromedriver_win32\\chromedriver.exe");
    ...
    public void testSearchAndGoToBddWiki() {
        ...
        WebElement wikiLink = chromeDriver.findElement(By.cssSelector("#rso > div:nth-child(1) > div.g.tF2Cxc > div > div.NJo7tc.Z26q7c.jGGQ5e > div > a > h3"));
